<template>
  ...
  <div class="w-full search-menu p-4 bg-white shadow-md rounded-lg">
    <!-- 검색 텍스트와 검색 필드를 토글하는 부분 -->

    <!-- 검색 필드 -->
    <div v-show="isSearchVisible" key="search-fields">
      <!-- 이름 검색 -->
      ...
      <!-- 회원 상태 검색 -->
      <div class="search-field mb-4">
        <label for="status" class="block text-sm font-medium text-gray-700 mb-1">회원 상태</label>
        <select
...
export default {
  data() {
    return {
      ...
      isSearchVisible: true, // 검색 필드의 가시성을 관리
    };
  },
  methods: {
    showSearchMenu() {
