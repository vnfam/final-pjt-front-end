<template>
  <h2 class="text-lg font-semibold my-10">공사 예정일을 선택해주세요.</h2>
  <div class="space-y-3 mb-10">
    <label class="flex items-center">
      <input type="radio" name="schedule" value="1개월 이내" v-model="schedule" class="mr-2 my-5">
      1개월 이내
    </label>
    <label class="flex items-center">
    ...
    <label class="flex items-center">
      <input type="radio" name="schedule" value="3개월 이내" v-model="schedule" class="mr-2 my-5">
      3개월 이내
    </label>
    <label class="flex items-center">
    ...
    <label class="flex items-center">
      <input type="radio" name="schedule" value="미정" v-model="schedule" class="mr-2 my-5">
      미정
    </label>
  </div>
