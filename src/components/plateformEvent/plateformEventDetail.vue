<template>
  <div class="container w-[850px] mx-auto p-8">
    ...
    <!-- <div class="my-carousel mb-8">
      <swiper
        v-if="plateformEventImageResponses.length > 1"
      ...
      >
        <swiper-slide v-for="(image, index) in plateformEventImageResponses" :key="index">
          <img
            class="w-[850px] h-[400px] object-cover rounded-lg"
            :src="image.imageUrl || require('@/assets/logo.png')"
            alt="plateformEvent Image"
          />
        </swiper-slide>
      </swiper>
      <img
        ...
        :src="plateformEventImageResponses[0]?.imageUrl || require('@/assets/logo.png')"
        alt="plateformEvent Image"
      />
    </div> -->
    ...
    <div class="bg-white p-6 mb-8 border-b-[1px] border-gray-200">
      ...
      <div class="flex justify-between items-center text-gray-600">
        <div>
          <p class="text-md text-gray-600 mb-1 font-semibold">{{ adminName }} 관리자</p>
    ...
    <div class="bg-white p-6 pb-20 rounded-lg border-b-[1px] border-gray-200">
      <div v-html="content" class="text-gray-700 leading-relaxed"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  //   async mounted() {
  //     const plateformEventId = this.$route.params.id;
  //     const plateformEventDetailRequest = await authInstance.get(`/api/plateformEvents/${plateformEventId}`);
  //     this.plateformEventDetail = plateformEventDetailRequest.data;
  //     console.log(this.plateformEventDetail);
  //   },
